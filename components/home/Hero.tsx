...
function Hero() {
  return (
    <>
      ...
      >
        <p className="text-xl mb-5">Hi👋, I'm Alan.</p>
        <h1 className="heroTitle inline-block max-w-2xl lg:max-w-4xl  w-auto relative text-5xl md:text-6xl lg:text-7xl tracking-tighter mb-10 font-bold heroShinyBg">
          I love <span className="heroShiny1 text-fun-pink">Web2</span> and{" "}
          <span className="heroShiny2 text-fun-pink">Web3</span> for the
          Defi world.
          <img
          ...
          <img
            ...
            src="/static/doodles/hero/defi.svg"
          />
          <img
