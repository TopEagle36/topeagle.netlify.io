    ...
    >
      ...
      {!tag && (
        <p className="text-fun-gray text-xl sm:text-2xl max-w-3xl m-auto">
          I've developed numerous innovative DeFi applications using Solidity, Rust, Anchor, C++, React, Next.js, Django, Express, and Web3, working across EVM, Solana, Tron, TON, and EOSIO networks.
          Here are some of my favorite projects from my journey.
        </p>
      )}
    </div>
  );
